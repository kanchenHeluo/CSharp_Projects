...
namespace Web.UI.Models
{
    public class Agreement
    {
        ...
        /// <summary>
        /// POAgreementNumber - for SLP (Select Plus)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets primary customer name 
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets BilltoPCN
        /// </summary>
        public string PartnerNumber { get; set; }

        public bool IsLotus { get; set; }
        /// <summary>
        /// Gets or sets the Agreement Start Date from Start Date
        /// </summary>
        ...
        /// <summary>
        /// Gets a duration string
        /// </summary>
        public string Duration
        {
            get { return "{0:d} - {1:d}".Format(StartEffectiveDate, EndEffectiveDate); }
        }

#if Used
        //Copied from repository, only enable fields that UI used , disable below
